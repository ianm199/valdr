...
// PORT NOTE: C module-level statics translated to thread_local! + RefCell
...
/// Corresponds to the C statics `x[3]`, `a[3]`, and `c`.
/// Normally accessed through the module-level functions [`server_lrand48`]
...
/// Advances the global PRNG and returns the next pseudo-random value
/// `[0, `[`SERVER_LRAND48_MAX`]`]`.
